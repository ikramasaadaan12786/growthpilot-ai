...
export async function GET() {
  try {
    ...
    const envAudit = {
      ...
      TIKTOK_SANDBOX_CLIENT_KEY: Boolean(process.env.TIKTOK_SANDBOX_CLIENT_KEY) ? 'CONFIGURED' : 'MISSING',
      TIKTOK_SANDBOX_CLIENT_SECRET: Boolean(process.env.TIKTOK_SANDBOX_CLIENT_SECRET) ? 'CONFIGURED' : 'MISSING',
